...
[^1]: For example, using an arduino + nrf24 makes it easy to remote control just about anything without having to spends weeks understanding radio signals, oscillators, mixing, signal encoding, etc.. Once the desire to understand those parts has been sparked, we can start building crystal oscillators and simple R/C circuits as dedicated projects to fill in the gap.